...
Your manager at Patagonia is very interested in determining the trend in sales transactions over time. That sounds easy enough, so you ask her to get you the data so you can give it a try. This is what the CRM export looks like. How can you work with this using functions we've learned?
...
This was somewhat of a trick question, because there is an easier way to format this data.
...
Let's say you're building a predictive model for Patagonia, when you realize that the customer zip codes are being treated as numeric data by R. Why might this be a problem? How could you use coercion to fix it?
...
Using the skills we learned today, the company would like us to create a graph that clearly displays the trend in 2018 transactions for married, college educated customers in the South region. How can we accomplish this using the two datasets we have access to?
